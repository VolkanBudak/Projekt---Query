...
function saveNote(){
    ...
    let notes = localStorage.getItem('notes') ? JSON.parse(localStorage.getItem('notes')) : []; //går in i local storage, om det finns data i den så hämtar den med hjälpt av local storage getItem annars returnera en tom array
